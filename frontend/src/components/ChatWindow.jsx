...
export default function ChatWindow({ chatId, isDark }) {
  ...
  const simulateBotResponse = async (userMessage) => {
    ...
    // Simple bot responses (you can replace this with actual AI integration)
    const responses = [
      ...
      "That reminds me of something similar. Would you like to explore that connection?",
    ]
  ...
  return (
    <div className={`flex-1 flex flex-col ${
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        <AnimatePresence>
          {isTyping && (
            ...
            >
              <div className={`max-w-xs lg:max-w-md px-4 py-2 rounded-2xl rounded-bl-md ${
                isDark
      ...
      <MessageInput 
        chatId={chatId} 
        isDark={isDark} 
        onMessageSent={simulateBotResponse}
      />
    </div>
  )
}